...
Системный вызов wait() может 
* заблокироваться (если все сыновии процессы ещё выполняются);
* завершиться, вернув код завершения сына (если сын завершился и ожидает, чтобы кто-то получил его код завершения);
* завершиться, вернув -1 (если нет сыновьих процессов).
